...
public interface TLongByteMap {
     ...
     * if none was found (see {@link #getNoEntryValue}).
     */
    byte putIfAbsent(long key, byte value);
     ...
     */
    boolean forEachEntry(TLongByteProcedure procedure);
     ...
     */
    boolean retainEntries(TLongByteProcedure procedure);
     ...
     * @return true if a mapping was found and modified.
     */
    boolean adjustValue(long key, byte amount);
     ...
     */
    byte adjustOrPutValue(long key, byte adjust_amount, byte put_amount);
}
