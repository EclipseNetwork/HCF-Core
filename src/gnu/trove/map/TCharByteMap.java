...
public interface TCharByteMap {
     ...
     * if none was found (see {@link #getNoEntryValue}).
     */
    byte putIfAbsent(char key, byte value);
     ...
     */
    boolean forEachEntry(TCharByteProcedure procedure);
     ...
     */
    boolean retainEntries(TCharByteProcedure procedure);
     ...
     * @return true if a mapping was found and modified.
     */
    boolean adjustValue(char key, byte amount);
     ...
     */
    byte adjustOrPutValue(char key, byte adjust_amount, byte put_amount);
}
