...
public enum ChatChannel {
    ...
    public String getRawFormat(Player player) {
        switch (this) {
            case FACTION:
                return SettingsYML.TEAMMATE_COLOUR + "(" + getDisplayName() + SettingsYML.TEAMMATE_COLOUR + ") " + player.getName() + ChatColor.GRAY + ": " + ChatColor.YELLOW + "%2$s";
            case ALLIANCE:
                return SettingsYML.ALLY_COLOUR + "(" + getDisplayName() + SettingsYML.ALLY_COLOUR + ") " + player.getName() + ChatColor.GRAY + ": " + ChatColor.YELLOW + "%2$s";
            default:
