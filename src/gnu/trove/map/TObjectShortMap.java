...
public interface TObjectShortMap<K> {
     ...
     * @return true if a mapping was found and modified.
     */
    boolean adjustValue(K key, short amount);
     ...
     */
    boolean forEachEntry(TObjectShortProcedure<? super K> procedure);
     ...
     */
    boolean retainEntries(TObjectShortProcedure<? super K> procedure);
