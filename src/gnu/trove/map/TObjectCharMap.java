...
public interface TObjectCharMap<K> {
     ...
     * @return true if a mapping was found and modified.
     */
    boolean adjustValue(K key, char amount);
     ...
     */
    boolean forEachEntry(TObjectCharProcedure<? super K> procedure);
     ...
     */
    boolean retainEntries(TObjectCharProcedure<? super K> procedure);
