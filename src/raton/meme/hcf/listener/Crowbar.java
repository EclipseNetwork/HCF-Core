...
public class Crowbar {
    ...
    public static final String CROWBAR_NAME = ChatColor.YELLOW.toString() + ChatColor.BOLD + ChatColor.ITALIC + "Crowbar";
    public static final String SPAWNER_USE_TAG = "Spawners";
    public static final String END_FRAME_USE_TAG = "End Frames";

    private static final String LORE_FORMAT = ChatColor.RED + "%1$s" + ChatColor.GRAY + " § " + ChatColor.YELLOW + "%2$s/%3$s";
