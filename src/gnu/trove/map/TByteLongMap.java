...
public interface TByteLongMap {
     ...
     * if none was found (see {@link #getNoEntryValue}).
     */
    long putIfAbsent(byte key, long value);
     ...
     */
    boolean forEachEntry(TByteLongProcedure procedure);
     ...
     */
    boolean retainEntries(TByteLongProcedure procedure);
     ...
     * @return true if a mapping was found and modified.
     */
    boolean adjustValue(byte key, long amount);
     ...
     */
    long adjustOrPutValue(byte key, long adjust_amount, long put_amount);
}
