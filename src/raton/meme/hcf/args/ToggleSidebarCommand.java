...
import raton.meme.hcf.scoreboard.PlayerBoard;
...
public class ToggleSidebarCommand implements CommandExecutor, TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.YELLOW + " Your scoreboard is " + (newVisibile ? ChatColor.GREEN + "now" : ChatColor.RED + "no longer") + ChatColor.YELLOW + " visible.");
        return true;
    }
