...
public interface TByteDoubleMap {
     ...
     * if none was found (see {@link #getNoEntryValue}).
     */
    double putIfAbsent(byte key, double value);
     ...
     */
    boolean forEachEntry(TByteDoubleProcedure procedure);
     ...
     */
    boolean retainEntries(TByteDoubleProcedure procedure);
     ...
     * @return true if a mapping was found and modified.
     */
    boolean adjustValue(byte key, double amount);
     ...
     */
    double adjustOrPutValue(byte key, double adjust_amount, double put_amount);
}
