...
public interface TByteShortMap {
     ...
     * if none was found (see {@link #getNoEntryValue}).
     */
    short putIfAbsent(byte key, short value);
     ...
     */
    boolean forEachEntry(TByteShortProcedure procedure);
     ...
     */
    boolean retainEntries(TByteShortProcedure procedure);
     ...
     * @return true if a mapping was found and modified.
     */
    boolean adjustValue(byte key, short amount);
     ...
     */
    short adjustOrPutValue(byte key, short adjust_amount, short put_amount);
}
