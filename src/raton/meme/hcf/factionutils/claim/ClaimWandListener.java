...
import raton.meme.hcf.listener.render.VisualBlock;
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (action == Action.LEFT_CLICK_BLOCK || action == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (plugin.getClaimHandler().canClaimHere(player, blockLocation)) {
                ...
                player.sendMessage(ChatColor.GREEN + "You have selected Position " + ChatColor.YELLOW + selectionId + ChatColor.GREEN + " at: " + ChatColor.GOLD + '(' + ChatColor.YELLOW
